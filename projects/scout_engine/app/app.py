...
PROJECT_NAME: str = "Scout Engine"
GITHUB_URL: str = "https://github.com/SebastianZapata/portfolio/tree/main/projects/scout_engine"
DEMO_URL: str = "https://huggingface.co/spaces/SebastianZapata/scout_engine"
